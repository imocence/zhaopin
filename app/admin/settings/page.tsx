...
export default function AdminSettingsPage() {
  const [activeTab, setActiveTab] = useState<'basic' | 'feature' | 'limit' | 'email'>('basic');
  const [settings, setSettings] = useState<AdminSettings>(() => {
    ...
    try {
      ...
      return savedSettings ? (JSON.parse(savedSettings) as AdminSettings) : defaultSettings;
    } catch {
      return defaultSettings;
    }
  });
    ...
    <div className="layui-fluid">
      ...
      <div className="layui-tab layui-tab-card" lay-filter="settingsTab">
        ...
        <div className="layui-tab-content">
          {/* 基本信息 */}
          <div className="layui-tab-item layui-show layui-card-body">
            <form className="layui-form layui-form-pane">
              ...
              <div className="layui-form-item">
                ...
                <div className="layui-input-block">
                  ...
                  />
                  <span className="layui-form-mid layui-word-aux">开启后，注册和登录时需要输入验证码</span>
                </div>
              </div>
            </form>
          </div>
          ...
          {/* 功能设置 */}
          <div className="layui-tab-item layui-card-body">
            <form className="layui-form layui-form-pane">
              <div className="layui-form-item">
                ...
                <div className="layui-input-block">
                  ...
                  />
                  <span className="layui-form-mid layui-word-aux">关闭后新用户无法注册</span>
                </div>
              </div>
              ...
              <div className="layui-form-item">
                ...
                <div className="layui-input-block">
                  ...
                  />
                  <span className="layui-form-mid layui-word-aux">开启后，企业必须通过认证才能发布职位</span>
                </div>
              </div>
            </form>
          </div>
