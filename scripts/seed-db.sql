...
INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('ca', '加利福尼亚州', '1', 'CA', '["洛杉矶","旧金山","圣何塞","圣地亚哥","萨克拉门托","弗雷斯诺","奥克兰"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('ny', '纽约州', '1', 'NY', '["纽约市","水牛城","罗切斯特","奥尔巴尼","雪城"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('tx', '德克萨斯州', '1', 'TX', '["休斯顿","达拉斯","奥斯汀","圣安东尼奥","沃斯堡"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('fl', '佛罗里达州', '1', 'FL', '["迈阿密","奥兰多","坦帕","杰克逊维尔"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('il', '伊利诺伊州', '1', 'IL', '["芝加哥","奥罗拉","纳珀维尔"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('pa', '宾夕法尼亚州', '1', 'PA', '["费城","匹兹堡","阿伦敦"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('wa', '华盛顿州', '1', 'WA', '["西雅图","斯波坎","塔科马"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('ma', '马萨诸塞州', '1', 'MA', '["波士顿","伍斯特","斯普林菲尔德"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('ga', '乔治亚州', '1', 'GA', '["亚特兰大","奥古斯塔","萨凡纳"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('nj', '新泽西州', '1', 'NJ', '["纽瓦克","泽西市","帕特森"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('nv', '内华达州', '1', 'NV', '["拉斯维加斯","里诺","亨德森"]');

INSERT OR REPLACE INTO locations (id, name, state, state_code, cities) VALUES ('az', '亚利桑那州', '1', 'AZ', '["凤凰城","图森","梅萨"]');